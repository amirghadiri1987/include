...
public:
                     CListView(void);
                    ~CListView(void);
   color             m_BgGround_Item, m_BgGround_Item_TextSel;
   //--- create
   ...
   void              SetBackGroundItem(const color BgGroundItem, const color BgGroundItemTextSel);
...
CListView::CListView(void) : m_offset(0),
                             ...
                             m_height_variable(false)
  {
   ...
   m_BgGround_Item = m_Themes.CONTROL_COMBOBOX_BACKGROUND_ITEM;
   m_BgGround_Item_TextSel = m_Themes.CONTROL_COMBOBOX_BACKGROUND_ITEM_TEXT_SELL;
  }
//+------------------------------------------------------------------+
//| Destructor                                                       |
//+------------------------------------------------------------------+
...
//--- check index
   if(index<0 || index>=ArraySize(m_rows))
      return(true);
//--- determine colors
   color  text_color=(select) ? m_BgGround_Item_TextSel : CONTROLS_LISTITEM_COLOR_TEXT; // CONTROLS_LISTITEM_COLOR_TEXT
   color  back_color=(select) ? CONTROLS_LISTITEM_COLOR_BG_SEL : m_BgGround_Item;
//--- get pointer
...
void CListView::SetBackGroundItem(const color BgGroundItem, const color BgGroundItemTextSel)
{
   m_BgGround_Item = BgGroundItem; 
   m_BgGround_Item_TextSel = BgGroundItemTextSel;
