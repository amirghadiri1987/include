...
protected:
   ...
   virtual bool      OnSetFont(void)              { return(m_button.Font(m_Fonts.FontsByIndex((int)Sets.FontName)));                  }
...
CButton::CButton(void)
  {
   ...
   m_color           =m_Themes.CONTROLS_BUTTON_TEXT;
   m_color_background=m_Themes.CONTROLS_BUTTON_DISABLE;
